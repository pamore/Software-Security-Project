...
urlpatterns = [
    ...
    url(r'^transaction/internal_critical/(?P<transaction_id>[1-9][0-9]*)/delete/$', views.validate_delete_internal_critical_transaction, name='validate_delete_internal_critical_transaction'),
    ...
    url(r'^transaction/internal_noncritical/(?P<transaction_id>[1-9][0-9]*)/delete/$', views.validate_delete_internal_noncritical_transaction, name='validate_delete_internal_noncritical_transaction'),
]
