...
urlpatterns = [
    ...
    url(r'^account/view/checking/statements/$', views.checking_statement, name='checking_statement'),
    url(r'^account/view/savings/statements/$', views.savings_statement, name='savings_statement'),
