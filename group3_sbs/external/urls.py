...
urlpatterns = [
    ...
    url(r'^account/view/statements/checking_and_savings/$', views.all_statements, name='all_statements'),
    ...
    url(r'^account/request_payment_email/$', views.request_payment_email, name='request_payment_email'),
    url(r'^account/addPaymentRequestToDB/$', views.addPaymentRequestToDB, name='add_merchantPaymentRequest_toDB'),
