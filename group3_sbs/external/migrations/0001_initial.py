# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-09-18 18:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resolver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='externalcriticaltransaction_resolver', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resolver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='externalnoncriticaltransaction_resolver', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checking_account', models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, to='external.CheckingAccount')),
                ('credit_card', models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, to='external.CreditCard')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, to='external.SavingsAccount'),
        ),
        migrations.AddField(
            model_name='merchantorganization',
            name='user',
